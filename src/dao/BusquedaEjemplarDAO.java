...
public class BusquedaEjemplarDAO {
    ...
    public ArrayList<String> obtenerTipoMaterial() {
        ...
        // retornando mi arraylist ya rellenado
        return tipos;
    }
    ...
    public ArrayList<Object> obtenerListaPorTipo(String tipo) {
        ...
        // haciendo uso de try-with-resource para cierres de conecciones aut.
            try (ResultSet res = obtennerLista.executeQuery();) {
                 //recorriendo el result set y llenando ek array list
                while (res.next()) {
            ...
            log.error("Error al obtener lista por tipo", e);
        }
        // retornando mi arraylist ya rellenado
        return lista;
    }
